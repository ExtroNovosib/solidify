# SOLID-O/discriminator-dispatch

Heuristic check for **discriminator dispatch** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-O/discriminator-dispatch reason`.
...
```go
// Positive: the focused positive fixture for SOLID-O/discriminator-dispatch crosses the documented signal.
