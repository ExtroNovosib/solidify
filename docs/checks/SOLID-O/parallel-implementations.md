# SOLID-O/parallel-implementations

Heuristic check for **parallel implementations** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-O/parallel-implementations reason`.
...
```go
// Positive: the focused positive fixture for SOLID-O/parallel-implementations crosses the documented signal.
