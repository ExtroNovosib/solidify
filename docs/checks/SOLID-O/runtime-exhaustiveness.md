# SOLID-O/runtime-exhaustiveness

Heuristic check for **runtime exhaustiveness** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-O/runtime-exhaustiveness reason`.
...
```go
// Positive: the focused positive fixture for SOLID-O/runtime-exhaustiveness crosses the documented signal.
