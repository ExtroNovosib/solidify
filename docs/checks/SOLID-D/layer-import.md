# SOLID-D/layer-import

Heuristic check for **layer import** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-D/layer-import reason`.
...
```go
// Positive: the focused positive fixture for SOLID-D/layer-import crosses the documented signal.
