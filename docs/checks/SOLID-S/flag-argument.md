# SOLID-S/flag-argument

Heuristic check for **flag argument** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-S/flag-argument reason`.
...
```go
// Positive: the focused positive fixture for SOLID-S/flag-argument crosses the documented signal.
