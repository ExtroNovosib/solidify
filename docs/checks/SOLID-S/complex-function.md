# SOLID-S/complex-function

Heuristic check for **complex function** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-S/complex-function reason`.
...
```go
// Positive: the focused positive fixture for SOLID-S/complex-function crosses the documented signal.
