...
Heuristic check for **data clump** smells in Go code.

Example: scan the package directory and review the reported evidence before suppressing with `//solidify:ignore SOLID-S/data-clump reason`.
...
```go
// Positive: the focused positive fixture for SOLID-S/data-clump crosses the documented signal.
